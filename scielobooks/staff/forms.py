...
class MonographForm():
    ...
    def get_form(cls, localizer):
        ...
        base_schema['format'].description = localizer.translate(_('Book size "width x height"'))
        base_schema['book'].title = localizer.translate(_('Format'))
        base_schema['book'].description = localizer.translate(_('Book size "width x height"'))
        base_schema['about_author'].title = localizer.translate(_('About the Author'))
        base_schema['about_author'].description = localizer.translate(_('About the Author'))
